        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {tutorials.map((post, index) => (
            <motion.div
              ...
              className="group p-8 bg-white/[0.03] border border-white/10 rounded-3xl backdrop-blur-md hover:border-primary/30 transition-all duration-500 hover:shadow-[0_40px_80px_rgba(0,0,0,0.6)] shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
            >
              ...
              <div className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.2em] text-primary opacity-0 group-hover:opacity-100 transition-all duration-500 translate-x-[-10px] group-hover:translate-x-0">
